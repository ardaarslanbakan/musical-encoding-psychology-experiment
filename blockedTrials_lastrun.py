...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/ardaarslanbakan/Desktop/musical_encoding/blockedTrials_lastrun.py',
...
text_4 = visual.TextStim(win=win, name='text_4',
    text='Deneyimize hoşgeldiniz. Birazdan 10 tane cümle dinleyeceksiniz. Aklınızda tutmaya çalışın.',
    font='Arial',
...
text = visual.TextStim(win=win, name='text',
    ...
    depth=0.0);
condNum = randint(1,5)
condFile = 'chooseBlock' + str(condNum) + '.csv'

# Initialize components for Routine "trial"
trialClock = core.Clock()

# Initialize components for Routine "math_text"
math_textClock = core.Clock()
text_2 = visual.TextStim(win=win, name='text_2',
    text='Önünüze matematik soruları çıkacaktır. Aklınızdan ya da kağıt üzerine çözünüz.',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# Initialize components for Routine "data_text"
data_textClock = core.Clock()
text_3 = visual.TextStim(win=win, name='text_3',
    text='Az sonra sizden hatırladığınız kelimeleri yazmanız istenecektir. Hatırladığınız kelimleri yazınca fare imleci ile SON’a tıklayanız.',
    font='Arial',
    pos=(0, 0), height=0.1, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1, 
    languageStyle='LTR',
...
# Initialize components for Routine "data_collection"
data_collectionClock = core.Clock()
textbox = visual.TextBox2(
     win, text='Type the words you remember\n\n', font='Arial',
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if text_4.status == STARTED:
        ...
        if tThisFlipGlobal > text_4.tStartRefresh + 30.0-frameTolerance:
...
# ------Prepare to start Routine "math_text"-------
continueRoutine = True
routineTimer.add(40.000000)
# update component parameters for each repeat
# keep track of which components have finished
math_textComponents = [text_2]
for thisComponent in math_textComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
math_textClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "math_text"-------
while continueRoutine and routineTimer.getTime() > 0:
    # get current time
    t = math_textClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=math_textClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if text_2.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_2.tStartRefresh + 40.0-frameTolerance:
            # keep track of stop time/frame for later
...
continueRoutine = True
routineTimer.add(130.000000)
# update component parameters for each repeat
# keep track of which components have finished
mathComponents = [movie_2]
...
while continueRoutine and routineTimer.getTime() > 0:
    ...
    if movie_2.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > movie_2.tStartRefresh + 130.0-frameTolerance:
            # keep track of stop time/frame for later
...
# ------Prepare to start Routine "data_text"-------
continueRoutine = True
routineTimer.add(40.000000)
# update component parameters for each repeat
# keep track of which components have finished
data_textComponents = [text_3]
for thisComponent in data_textComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
data_textClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "data_text"-------
while continueRoutine and routineTimer.getTime() > 0:
    # get current time
    t = data_textClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=data_textClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
    ...
    if text_3.status == STARTED:
        # is it time to stop? (based on global clock, using actual start)
        if tThisFlipGlobal > text_3.tStartRefresh + 40.0-frameTolerance:
            # keep track of stop time/frame for later
...
# ------Prepare to start Routine "data_collection"-------
continueRoutine = True
# update component parameters for each repeat
textbox.reset()
...
# keep track of which components have finished
data_collectionComponents = [textbox, endButton, mouse]
for thisComponent in data_collectionComponents:
    thisComponent.tStart = None
    thisComponent.tStop = None
    thisComponent.tStartRefresh = None
    thisComponent.tStopRefresh = None
...
t = 0
_timeToFirstFrame = win.getFutureFlipTime(clock="now")
data_collectionClock.reset(-_timeToFirstFrame)  # t0 is time of first possible flip
frameN = -1

# -------Run Routine "data_collection"-------
while continueRoutine:
    # get current time
    t = data_collectionClock.getTime()
    tThisFlip = win.getFutureFlipTime(clock=data_collectionClock)
    tThisFlipGlobal = win.getFutureFlipTime(clock=None)
    frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
    # update/draw components on each frame
...
# -------Ending Routine "data_collection"-------
for thisComponent in data_collectionComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
...
thisExp.nextEntry()
# the Routine "data_collection" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()
